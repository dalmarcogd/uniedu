package keep.user.server.core.hibernate.config;
...
public class HibernateConfig {
    ...
    public static Properties getDefaultProperties(){
        ...
        properties.put("hibernate.multi_tenant_connection_provider", "keep.user.server.core.hibernate.multitenancy.HibernateDataSourceBasedMultiTenantConnectionProviderImpl");
        properties.put("hibernate.tenant_identifier_resolver", "keep.user.server.core.hibernate.multitenancy.HibernateCurrentTenantIdentifierResolverImpl");
