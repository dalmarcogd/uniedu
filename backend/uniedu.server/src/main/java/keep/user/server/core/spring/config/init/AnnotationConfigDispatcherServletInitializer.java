package keep.user.server.core.spring.config.init;

import org.springframework.context.ApplicationContextInitializer;
import org.springframework.context.ConfigurableApplicationContext;
import org.springframework.web.servlet.support.AbstractAnnotationConfigDispatcherServletInitializer;

import keep.user.server.core.spring.config.root.SpringFrameworkRootConfigurer;
import keep.user.server.core.spring.config.security.SpringWebSecurityConfigurerAdapter;
