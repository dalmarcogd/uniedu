package uniedu.server.core.criteria;
...
import uniedu.server.core.hibernate.service.HibernateManagerSessionFactoryService;
import uniedu.server.core.spring.context.ScopeType;
