package uniedu.server.core.hibernate.config;
...
public class HibernateConfig {
    ...
    public static Properties getDefaultProperties(){
        ...
        properties.put("hibernate.multi_tenant_connection_provider", "uniedu.server.core.hibernate.multitenancy.HibernateDataSourceBasedMultiTenantConnectionProviderImpl");
        properties.put("hibernate.tenant_identifier_resolver", "uniedu.server.core.hibernate.multitenancy.HibernateCurrentTenantIdentifierResolverImpl");
